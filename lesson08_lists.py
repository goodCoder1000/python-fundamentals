...
print(matrix[2][2]) # getting a value in a 2d array
...
# Challenge 1
print([1, 2, int(input("give integer: ")), 4, 5, 6])

# Challenge 2
shopping = []
shopping.extend(["chicken", "tikka masala", "67 spices"])
shopping.insert(1, "curry masala")
shopping.remove("tikka masala")
print(shopping)

# one liner
shopping = []; shopping.extend(["chicken", "tikka masala", "67 spices"]); shopping.insert(1, "curry masala"); shopping.remove("tikka masala"); print(shopping)
